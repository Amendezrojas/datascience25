...
plt.title("Distribución de Edad de Votantes")
plt.xlabel("Edad")
...
# Barplot: participación electoral promedio por región
...
# Pairplot: relación entre participación, ingresos y confianza
...
# FacetGrid: participación electoral por educación y región
